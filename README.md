...
Feedback on the use of this work, suggestions for improvements and identified issues are welcome and can be provided using GitGub issue tracking. To engage in the development and update of NETN-BASE, please contact your national NMSG representative.

Version numbering of the NETN BASE FOM Module and associated documentation is based on the following principles:
